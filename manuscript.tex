...
top=12mm,          % Minimal top margin
bottom=12mm,       % Minimal bottom margin
...
\begin{itemize}
\item Online: bookchanges.com/bhagavad-gita-changes-complete-list
\end{itemize}

"Changes in Bhagavad-gita." \emph{Krishna Books}.
\begin{itemize}
\item Online: krishna-books.com/77-of-bg-verses-is-changed.html
\end{itemize}
...
\begin{itemize}
\item bookchanges.com
\item krishna-books.com
\item arsaprayoga.com
\end{itemize}
...
\begin{center}
\includegraphics[width=2.5in]{jaganat_2k.jpg}
\end{center}
\vspace{0.5cm}
