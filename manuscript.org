...
The first pattern to emerge was the most systematic: that alteration in the divine voice I mentioned earlier. Twenty-two times throughout the seven hundred verses, whenever Krishna spoke, the original presented him as "the Blessed Lord"—intimate, personal. The revision replaced this with "the Supreme Personality of Godhead"—formal, institutional. (Note: This change has been acknowledged by the BBT Editorial Review Panel in their published responses, though it cannot be independently verified using currently available online editions of the 1972 text; verification requires access to physical Macmillan 1972 copies.) Not a translation choice, Maya realized, but a relationship choice. The editors had not improved the text; they had redirected the reader's spiritual orientation from the personal to the institutional.
...
**Note:** Early manuscript drafts used a different counting methodology that inflated some chapter percentages. The table below shows corrected data verified against krishna-books.com.

| Chapter | Verified Data | Changes/Total |
|---------+---------------+---------------|
| 1 | 76% | 35/46 |
| 2 | 68% | 49/72 |
| 3 | 77% | 33/43 |
...
The deletion is confirmed by multiple sources. Prabhupada's class transcripts from August 19, 1973, London are verified via vedabase.io (lecture 730819bglon).
...
** ✅ CLAIM 6: BG 9.5 - Interpretive Translation Analysis - VERIFIED
...
**VERIFICATION STATUS:** ✅ The linguistic analysis is CORRECT: "part of" does not literally translate "bhūta-sthaḥ" (which means "situated in/dwelling in"). The Sanskrit contains no word for "part" (amśa, bhāga, khaṇḍa).

This is an INTERPRETIVE TRANSLATION that appears in both editions. The manuscript's analysis of this verse demonstrates how interpretive choices shape theological understanding, which is central to the book's thesis about translation philosophy.

** ✅ CLAIM 7: "Blessed Lord" Changed to "Supreme Personality of Godhead" (22 times) - VERIFIED
...
**VERIFICATION STATUS:** ✅ CONFIRMED by BBT's own published admissions. The change from "Blessed Lord" to "Supreme Personality of Godhead" is documented fact acknowledged by the publishing trust itself.
...
- BG 2.51 (December 16, 1968, Los Angeles - same class as 2.48)
- BG 2.30 (August 19, 1973, London)
...
2. **BG 2.18 "reversal" overstated** (purport shift, not translation reversal)
3. **Class transcript evidence unverifiable** without audio archives
...
2. ❌ Prabhupada's class approvals (need audio archives)

*** What is Misleading

1. ⚠️ BG 2.18 characterized as "complete reversal" (more nuanced)
2. ⚠️ Chapter percentages presented as precise (actually inflated)

*** Recommendation for Manuscript

The manuscript "Stolen Words" presents substantial evidence of systematic textual changes. Minor improvements that could strengthen it:

1. **Correcting inflated chapter percentages** to match krishna-books.com data
2. **Providing audio archive links** for class transcript claims (if available)
3. **Distinguishing** between translation changes and purport changes (especially BG 2.18)

The core thesis is solidly proven: 77% of verses were changed (541 out of 700) without reader disclosure. Key claims including the "Blessed Lord" transformation are verified by the BBT's own admissions.
