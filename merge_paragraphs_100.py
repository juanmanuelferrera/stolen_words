#!/usr/bin/env python3
"""
Target approximately 100 paragraphs for ElevenLabs.
"""

def merge_paragraphs_100(input_file, output_file, max_short_length=600):
    """
    Merge to get approximately 100 paragraphs.
    """
    ...
    for para in paragraphs:
        ...
        if len(para) > max_short_length:
            ...
            if len(' '.join(buffer)) > max_short_length * 4:
                merged.append(' '.join(buffer))
                buffer = []
...
if __name__ == '__main__':
    merge_paragraphs_100('manuscript_elevenlabs.txt', 'manuscript_elevenlabs_merged.txt', max_short_length=600)
